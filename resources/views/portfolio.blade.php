            ...
            <div class="col-md-10 col-md-offset-1">
                <form action="/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="Input1">Кличка тварини</label>
                        <input type="text" name="name" class="form-control" id="Input1" placeholder="Кличка" required>
                    </div>
                    <div class=" form-group">
                        <label for="Input5">Вид тварини</label>
                        <select class=" form-control" id="Input5" name="species">
                    ...
                    <div class="form-group">
                        <label for="Input4">Адреса де знакла тварина</label>
